...
import com.android.login.BuildConfig
...
import com.android.network.observer.ToastObserver
import com.android.network.transformer.CommonTransformer
...
class LoginVM : ViewModel() {
    ...
    init {
        loginRemote = NetWorkApi.instance.createService(LoginRemote::class.java)
    }
