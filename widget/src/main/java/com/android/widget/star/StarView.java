package com.android.widget.star;
...
public class StarView extends View {
    ...
    private void init(Context context) {
        ...
        signTextSize = DimenUtil.sp2px(context, 9.0f);
