 ...
 */
public abstract class ZdAdapter<T> extends BaseAdapter implements View.OnClickListener{
    ...
    public ZdAdapter(Context context, List<T> data, int layoutId) {
        this.mContext = context;
        this.mData = data;
        this.mLayoutId = layoutId;
    }

    public ZdAdapter(Context context, List<T> data, int layoutId, Callback mCallback) {
        this.mContext = context;
        this.mData = data;
        this.mLayoutId = layoutId;
    ...
    public ZdAdapter<T> setViewTypeCount(int count) {
        this.count = count;
        return this;
    }

    public ZdAdapter<T> setItemViewType(int index) {
        this.index = index;
        return this;
    }
