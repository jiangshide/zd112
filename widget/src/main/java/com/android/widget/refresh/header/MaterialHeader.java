package com.android.widget.refresh.header;
...
import com.android.widget.refresh.header.material.CircleImageView;
import com.android.widget.refresh.header.material.MaterialProgressDrawable;
...
/**
 * created by jiangshide on 2019/3/11.
...
public class MaterialHeader extends InternalAbstract implements RefreshHeader {
    ...
    //    protected static final int CIRCLE_BG_LIGHT = 0xFFFFFF00;
    ...
    public MaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        thisView.setMinimumHeight(DimenUtil.dp2px(100));
...
//        mProgress.setColorSchemeColors(0xff0099cc, 0xffff4444, 0xff669900, 0xffaa66cc, 0xffff8800);
        mProgress.setColorSchemeColors(0xffffd200, 0xffffd200, 0xffffd200, 0xffffd200, 0xffffd200);
...
//    }
    ...
    public MaterialHeader setColorSchemeResources(@ColorRes int... colorIds) {
        ...
        for (int i = 0; i < colorIds.length; i++) {
            colors[i] = ZdRefreshManager.getInstance().getColor(context, colorIds[i]);
        }
