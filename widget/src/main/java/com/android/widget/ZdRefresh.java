...
import com.android.widget.refresh.component.ClassicsFooter;
import com.android.widget.refresh.component.ClassicsHeader;
import com.android.widget.refresh.interfaces.*;
import com.android.widget.refresh.runable.DelayedRunnable;
import com.android.widget.refresh.state.RefreshState;
import com.android.widget.refresh.state.SpinnerStyle;
import com.android.widget.refresh.wrapper.RefreshContentWrapper;
import com.android.widget.refresh.wrapper.RefreshFooterWrapper;
import com.android.widget.refresh.wrapper.RefreshHeaderWrapper;
import com.android.widget.refresh.wrapper.ScrollBoundaryDeciderAdapter;
 ...
 */
public class ZdRefresh extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
...
//        setWord(BaseApplication.word);
    ...
    public ZdRefresh(Context context) {
        this(context, null);
    }

    public ZdRefresh(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZdRefresh(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setNestedScrollingEnabled(ta.getBoolean(R.styleable.RefreshView_rfEnableNestedScrolling, false));
        mDragRate = ta.getFloat(R.styleable.RefreshView_rfDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.RefreshView_rfHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.RefreshView_rfFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.RefreshView_rfHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.RefreshView_rfFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.RefreshView_rfEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.RefreshView_rfReboundDuration, mReboundDuration);
        mEnableLoadMore = ta.getBoolean(R.styleable.RefreshView_rfEnableLoadMore, mEnableLoadMore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.RefreshView_rfHeaderHeight, DimenUtil.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.RefreshView_rfFooterHeight, DimenUtil.dip2px(60));
        mHeaderInsetStart = ta.getDimensionPixelOffset(R.styleable.RefreshView_rfHeaderInsetStart, 0);
        mFooterInsetStart = ta.getDimensionPixelOffset(R.styleable.RefreshView_rfFooterInsetStart, 0);
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.RefreshView_rfDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.RefreshView_rfDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.RefreshView_rfEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.RefreshView_rfEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.RefreshView_rfEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadMore = ta.getBoolean(R.styleable.RefreshView_rfEnableAutoLoadMore, mEnableAutoLoadMore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.RefreshView_rfEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.RefreshView_rfEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.RefreshView_rfEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(R.styleable.RefreshView_rfEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadMoreWhenContentNotFull = ta.getBoolean(R.styleable.RefreshView_rfEnableLoadMoreWhenContentNotFull, mEnableLoadMoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(R.styleable.RefreshView_rfEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableClipHeaderWhenFixedBehind = ta.getBoolean(R.styleable.RefreshView_rfEnableClipHeaderWhenFixedBehind, mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta.getBoolean(R.styleable.RefreshView_rfEnableClipFooterWhenFixedBehind, mEnableClipFooterWhenFixedBehind);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.RefreshView_rfEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.RefreshView_rfFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.RefreshView_rfFixedFooterViewId, View.NO_ID);
        mHeaderTranslationViewId = ta.getResourceId(R.styleable.RefreshView_rfHeaderTranslationViewId, View.NO_ID);
        mFooterTranslationViewId = ta.getResourceId(R.styleable.RefreshView_rfFooterTranslationViewId, View.NO_ID);

        if (mEnablePureScrollMode && !ta.hasValue(R.styleable.RefreshView_rfEnableOverScrollDrag)) {
            mEnableOverScrollDrag = true;
        }

        mManualLoadMore = ta.hasValue(R.styleable.RefreshView_rfEnableLoadMore);
        mManualNestedScrolling = ta.hasValue(R.styleable.RefreshView_rfEnableNestedScrolling);
        mManualHeaderTranslationContent = ta.hasValue(R.styleable.RefreshView_rfEnableHeaderTranslationContent);
        mHeaderHeightStatus = ta.hasValue(R.styleable.RefreshView_rfHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.RefreshView_rfFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;

        int accentColor = ta.getColor(R.styleable.RefreshView_rfAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.RefreshView_rfPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (ZdRefreshManager.getInstance().isScrollableView(view) && (contentLevel < 2 || i == 1)) {
                indexContent = i;
                contentLevel = 2;
    ...
    protected void onAttachedToWindow() {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshContent == null) {
                final int padding = DimenUtil.dp2px(20);
                final TextView errorView = new TextView(thisView.getContext());
                errorView.setTextColor(0xffff6600);
                errorView.setGravity(Gravity.CENTER);
                errorView.setTextSize(20);
                errorView.setText(R.string.rf_content_empty);
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = ZdRefresh.this;
                        for (ViewParent parent = thisView.getParent(); parent != null; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = ZdRefresh.this;
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (onTouchEventListener != null && (scroll > 40 || scroll < -40)) {
                    onTouchEventListener.onMove(scrollY);
                }
            ...
            case MotionEvent.ACTION_UP://向上抬起时处理速度追踪
                if (onTouchEventListener != null) {
                    onTouchEventListener.onUp(scrollY);
                }
                mVelocityTracker.addMovement(e);
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(ZdRefresh.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(ZdRefresh.this, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(ZdRefresh.this);
...
//                mVelocity *= Math.pow(mDamping, ++mFrame);
                ...
                if (Math.abs(velocity) > 1) {
                    ...
                    if (mSpinner * mOffset > 0) {
                        ...
                        animationRunnable = null;
                        mKernel.moveSpinner(0, true);
                        ZdRefreshManager.getInstance().fling(mRefreshContent.getScrollableView(), (int) -mVelocity);
        ...
        public void run() {
            if (animationRunnable == this && !mState.isFinishing) {
                ...
                if (Math.abs(velocity) >= 1) {
                    ...
                    animationRunnable = null;
                    if (Math.abs(mSpinner) >= Math.abs(mSmoothDistance)) {
                        int duration = 10 * Math.min(Math.max((int) DimenUtil.px2dp(Math.abs(mSpinner - mSmoothDistance)), 30), 100);
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RefreshView_Layout);
            backgroundColor = ta.getColor(R.styleable.RefreshView_Layout_layout_rfBackgroundColor, backgroundColor);
            if (ta.hasValue(R.styleable.RefreshView_Layout_layout_rfSpinnerStyle)) {
                spinnerStyle = SpinnerStyle.values()[ta.getInt(R.styleable.RefreshView_Layout_layout_rfSpinnerStyle, SpinnerStyle.Translate.ordinal())];
            }
            ta.recycle();
        }
    ...
    public boolean canScrollVertically(int direction) {
        ...
        if (direction < 0) {
            return mEnableOverScrollDrag || isEnableRefresh() ||ZdRefreshManager.getInstance().canScrollUp(target);
        } else if (direction > 0) {
            return mEnableOverScrollDrag || isEnableLoadMore() || ZdRefreshManager.getInstance().canScrollDown(target);
        }
        return true;
    }

    @Override
    public ZdRefresh setFooterHeight(float heightDp) {
        if (mFooterHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mFooterHeight = DimenUtil.dp2px(heightDp);
    ...
    @Override
    public ZdRefresh setHeaderHeight(float heightDp) {
        if (mHeaderHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mHeaderHeight = DimenUtil.dp2px(heightDp);
    ...
    @Override
    public ZdRefresh setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = DimenUtil.dp2px(insetDp);
        return this;
    }

    @Override
    public ZdRefresh setFooterInsetStart(float insetDp) {
        mFooterInsetStart = DimenUtil.dp2px(insetDp);
        return this;
    }
     ...
     */
    @Override
    public ZdRefresh setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public ZdRefresh setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public ZdRefresh setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public ZdRefresh setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public ZdRefresh setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public ZdRefresh setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public ZdRefresh setReboundDuration(int duration) {
     ...
     */
    @Override
    public ZdRefresh setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public ZdRefresh setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public ZdRefresh setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public ZdRefresh setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public ZdRefresh setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public ZdRefresh setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public ZdRefresh setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public ZdRefresh setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public ZdRefresh setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public ZdRefresh setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
     ...
     */
    @Override
    public ZdRefresh setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public ZdRefresh setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public ZdRefresh setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
        final int[] colors = new int[primaryColorId.length];
        for (int i = 0; i < primaryColorId.length; i++) {
            colors[i] = ZdRefreshManager.getInstance().getColor(thisView.getContext(), primaryColorId[i]);
        }
     ...
     */
    @Override
    public ZdRefresh setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public ZdRefresh setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public ZdRefresh finishRefresh() {
     ...
     */
    @Override
    public ZdRefresh finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public ZdRefresh finishRefresh(int delayed) {
     ...
     */
    @Override
    public ZdRefresh finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public ZdRefresh finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(ZdRefresh.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            ZdRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop * 2, 0));
                            ZdRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
     ...
     */
    @Override
    public ZdRefresh finishLoadMore(int delayed) {
     ...
     */
    @Override
    public ZdRefresh finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public ZdRefresh finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(ZdRefresh.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            ZdRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            ZdRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
                        }
     ...
     */
    @Override
    public ZdRefresh finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return ZdRefresh.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
