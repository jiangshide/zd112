...
import com.android.star.adapter.AbsStarAdapter;
import com.android.star.adapter.StarAdapter;
import com.android.star.calculator.StarCalculator;
 ...
 */
public class Star extends ViewGroup implements Runnable, AbsStarAdapter.OnDataSetChangeListener {
        ...
        this.post(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < starAdapter.getCount(); i++) {
                    ...
                    View view = starAdapter.getView(getContext(), i, Star.this);
        ...
        if (!view.hasOnClickListeners() && onTagClickListener != null) {
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    onTagClickListener.onItemClick(Star.this, v, position);
                }
            });
        }
    }
