package com.android.star.adapter;
 ...
 */
public abstract class AbsStarAdapter<T> {
    ...
    protected abstract View getView(Context context, int position, ViewGroup parent, T t);
}
