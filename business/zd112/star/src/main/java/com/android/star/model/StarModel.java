package com.android.star.model;

import android.graphics.Color;
import android.view.View;

import com.android.star.StarView;
...
public class StarModel {
    ...
    public StarModel(float locX, float locY, float locZ, float scale, int popularity) {
        this.locX = locX;
        this.locY = locY;
        this.locZ = locZ;
    ...
    public StarModel(int popularity) {
        this(0f, 0f, 0f, 1.0f, popularity);
    }

    public StarModel(float locX, float locY, float locZ) {
        this(locX, locY, locZ, 1.0f, DEFAULT_POPULARITY);
    }

    public StarModel(float locX, float locY, float locZ, float scale) {
    ...
    public void setScale(float scale) {
        this.scale = scale;
        if (this.mView != null) {
            ((StarView) this.mView).setScale(scale);
        }
    }
