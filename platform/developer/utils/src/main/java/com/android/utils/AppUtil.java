...
public final class AppUtil {
    ...
    public static void giActivity(Class clazz) {
    ...
    public static String getPackageName(String path) {
        return getApplicationContext().getPackageManager().getPackageArchiveInfo(path, PackageManager.GET_ACTIVITIES | PackageManager.GET_SERVICES).packageName;
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = getApplicationContext().getPackageName() + ".utilcode.provider";
    ...
    public static ApplicationInfo getApplicationInfo(String path) {
        return getApplicationContext().getPackageManager().getPackageArchiveInfo(path, PackageManager.GET_ACTIVITIES | PackageManager.GET_SERVICES | PackageManager.GET_CONFIGURATIONS | PackageManager.GET_INTENT_FILTERS).applicationInfo;
    }

    public static ActivityInfo[] getActivityInfos(String path) {
        return getApplicationContext().getPackageManager().getPackageArchiveInfo(path, PackageManager.GET_ACTIVITIES).activities;
    }

    public static List<Activity> getActivitiesByApplication(Context context) {
