...
import com.android.refresh.interfaces.RefreshHeader;
import com.android.refresh.interfaces.RefreshLayout;
...
public class ClassicsHeader extends InternalClassics<ClassicsHeader> implements RefreshHeader {
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lpUpdateText.topMargin = ta.getDimensionPixelSize(R.styleable.ClassicsHeader_rfTextTimeMarginTop, DimenUtil.dip2px(0));
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_rfDrawableMarginRight, DimenUtil.dip2px(20));
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_rfTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_rfTextSizeTitle, DimenUtil.dp2px(16)));
        } else {
            mTitleText.setTextSize(12);
        }

        if (ta.hasValue(R.styleable.ClassicsHeader_rfTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_rfTextSizeTime, DimenUtil.dp2px(12)));
        } else {
    ...
    public ClassicsHeader setTextTimeMarginTop(float dp) {
        ...
        lp.topMargin = DimenUtil.dp2px(dp);
