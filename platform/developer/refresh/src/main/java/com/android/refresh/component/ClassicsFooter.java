...
//        lpProgress.leftMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_rfDrawableMarginRight, DimenUtil.dip2px(20));
//        lpArrow.leftMargin = lpProgress.leftMargin;
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_rfTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsFooter_rfTextSizeTitle, DimenUtil.dp2px(16)));
        } else {
