...
import com.android.refresh.component.ClassicsFooter;
import com.android.refresh.component.ClassicsHeader;
import com.android.refresh.interfaces.*;
import com.android.refresh.manager.Manager;
import com.android.refresh.runable.DelayedRunnable;
import com.android.refresh.state.RefreshState;
import com.android.refresh.state.SpinnerStyle;
import com.android.refresh.wrapper.RefreshContentWrapper;
import com.android.refresh.wrapper.RefreshFooterWrapper;
import com.android.refresh.wrapper.RefreshHeaderWrapper;
import com.android.refresh.wrapper.ScrollBoundaryDeciderAdapter;
 ...
 */
public class Refresh extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
...
//        setWord(BaseApplication.word);
    ...
    public Refresh(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (Manager.getInstance().isScrollableView(view) && (contentLevel < 2 || i == 1)) {
                indexContent = i;
                contentLevel = 2;
    ...
    protected void setStateDirectLoading() {
        if (mState != RefreshState.Loading) {
            ...
            if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                mOnMultiPurposeListener.onLoadMore();
    ...
    protected void setStateRefreshing() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(Refresh.this, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh();
...
//                mVelocity *= Math.pow(mDamping, ++mFrame);
                ...
                if (Math.abs(velocity) > 1) {
                    ...
                    if (mSpinner * mOffset > 0) {
                        ...
                        animationRunnable = null;
                        mKernel.moveSpinner(0, true);
                        Manager.getInstance().fling(mRefreshContent.getScrollableView(), (int) -mVelocity);
    ...
    public boolean canScrollVertically(int direction) {
        ...
        if (direction < 0) {
            return mEnableOverScrollDrag || isEnableRefresh() || Manager.getInstance().canScrollUp(target);
        } else if (direction > 0) {
            return mEnableOverScrollDrag || isEnableLoadMore() || Manager.getInstance().canScrollDown(target);
        }
        return true;
    }

    @Override
    public Refresh setFooterHeight(float heightDp) {
    ...
    @Override
    public Refresh setHeaderHeight(float heightDp) {
    ...
    @Override
    public Refresh setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = DimenUtil.dp2px(insetDp);
        return this;
    }

    @Override
    public Refresh setFooterInsetStart(float insetDp) {
     ...
     */
    @Override
    public Refresh setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public Refresh setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public Refresh setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public Refresh setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public Refresh setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public Refresh setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public Refresh setReboundDuration(int duration) {
     ...
     */
    @Override
    public Refresh setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public Refresh setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public Refresh setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public Refresh setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public Refresh setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public Refresh setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public Refresh setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public Refresh setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public Refresh setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public Refresh setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public Refresh setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
     ...
     */
    @Override
    public Refresh setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public Refresh setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public Refresh setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
        final int[] colors = new int[primaryColorId.length];
        for (int i = 0; i < primaryColorId.length; i++) {
            colors[i] = Manager.getInstance().getColor(thisView.getContext(), primaryColorId[i]);
        }
     ...
     */
    @Override
    public Refresh setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public Refresh setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public Refresh finishRefresh(int delayed) {
     ...
     */
    @Override
    public Refresh finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public Refresh finishRefresh(int delayed, final boolean success) {
     ...
     */
    @Override
    public Refresh finishLoadMore(int delayed) {
     ...
     */
    @Override
    public Refresh finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public Refresh finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
                        }
     ...
     */
    @Override
    public Refresh finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
