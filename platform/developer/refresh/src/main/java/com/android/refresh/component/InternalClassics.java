...
import com.android.refresh.interfaces.RefreshInternal;
...
//        centerLayout.addView(titleView, lpHeaderText);
    ...
    public T setPrimaryColorId(@ColorRes int colorId) {
        final View thisView = this;
        setPrimaryColor(Manager.getInstance().getColor(thisView.getContext(), colorId));
        return self();
    }

    public T setAccentColorId(@ColorRes int colorId) {
        final View thisView = this;
        setAccentColor(Manager.getInstance().getColor(thisView.getContext(), colorId));
        return self();
    }
